---
layout: default
title: classDefinedPropertyAnnotations
...
## Declaration
```matlab
 propertyAnnotations = CAAnnotatedClass.classVariableAnnotations()
```
## Returns
...
Help for WVDiagnostics.classDefinedPropertyAnnotations is inherited from superclass CAAnnotatedClass
