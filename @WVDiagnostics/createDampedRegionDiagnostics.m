...
% This adds the damped region diagnostics to an existing NetCDFFile. In the
% future this will just be built into the diagnostics directly.
arguments
    self WVDiagnostics
    options.stride = 1
    options.timeIndices
...
fprintf("Starting loop to compute the damped region diagnostics for %d time indices.\n",length(timeIndices));
